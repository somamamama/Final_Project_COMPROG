...
class Dashboard:
    ...
    # Clearing entries and updating the listbox can be done after displaying the product
         ...
         # Reset the entry fields to their initial states
    ...
    def add_product_to_database(self,product,quantity,price,cost):
      ...
      try:
        ...
        query = "INSERT INTO sales_database (product, quantity, price, cost) VALUES (%s, %s, %s, %s)"
    ...
    def delete_product_from_database(self, product):
        try:
            ...
            cursor = self.connection.cursor()
            query = "DELETE FROM sales_database WHERE product = %s"
            data = (product,)
            cursor.execute(query, data)
            self.connection.commit()
    ...
    def reset_data(self):
        ...
        if confirmation:
            try:
                ...
                query = "DELETE FROM sales_database"
    ...
    # Display added products
        ...
        try:
           cursor = self.connection.cursor()
           query = "SELECT product, quantity, price, cost FROM sales_database"
           cursor.execute(query)
